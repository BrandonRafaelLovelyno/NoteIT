export default function HomePage() {
    ...
    return (
        <div>
            <h1 className="text-3xl font-semibold mb-6 text-gray-800">Welcome home, Admin</h1>
            <section>
                <h2 className="text-xl font-medium mb-4 text-gray-700">Recent Activity</h2>
            ...
            <section className="mt-8">
                <h2 className="text-xl font-medium mb-4s text-gray-700">Deadlines !!!</h2>
